...
class UsuariosCM {
    constructor() {
        ...
        * @author obelmonte
        */
        this.actualizarVetado = (id, vetado) => __awaiter(this, void 0, void 0, function* () {
            ...
            const usuario = yield this.refUs.doc(id).update(datos)
                .then(() => __awaiter(this, void 0, void 0, function* () {
                const editado = yield this.obtenerUsuario(id);
                return editado;
            }))
                .catch(err => {
         ...
         * @author obelmonte
         */
        this.rebisarVetado = (id) => __awaiter(this, void 0, void 0, function* () {
            if (id === undefined || id === null || id === '') {
                return new DataNotFoundException_1.default(codigos_1.codigos.identificadorInvalido);
            }
            const registro = yield this.obtenerUsuario(id);
